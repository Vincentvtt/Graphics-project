...
//global directional lighting with ambient lighting. 
public class Lighting { 
	private final float a = 0.7f; // Ambient white light intensity.
	private final float d = 0.5f; // Diffuse white light intensity
	private final float s = 0.9f; // Specular white light intensity.
	
	private final float g = 0.05f; // Global Ambient intensity
	private int localViewer = 0; // Local viewpoint?
	

    
    public void setSunLighting(GL2 gl, float[] sunDirection, int angle) {
